 ...
 *
 * Navigation sidebar for community section
 *
 * Features:
 * - Community logo/branding
 * - Navigation links (Feed, Topics, Articles, Trending, Notifications)
 * - Active route highlighting
 * - Leaderboard display (input)
 */
@Component({
  ...
  template: `
    <aside class="space-y-4">
      ...
      <a
        ...
        class="flex items-center gap-3 px-4 py-3 bg-white/5 backdrop-blur-sm border border-purple-500/20 rounded-xl hover:bg-white/10 transition-all"
      >
        <div
      ...
      <!-- Navigation -->
      <div
        class="bg-white/5 backdrop-blur-sm border border-purple-500/20 rounded-xl p-4"
      >
